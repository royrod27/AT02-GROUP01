...
function getOutOfOrdersWithOutService(callback) {
    var url = generalConfig.url + outOfOrdersConfig.endpoint;
...
exports.getOutOfOrdersWithOutService = getOutOfOrdersWithOutService;
